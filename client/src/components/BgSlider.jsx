 ...
 const handleSliderChange = (e) => {
  ...
  return (
    <div className='pb-10 md:py-20 mx-2'>
      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-2 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent py-5'>Remove Background With High <br /> Quality and Accuracy</h1>
